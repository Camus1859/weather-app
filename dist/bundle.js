...
var momentTimeZone = __webpack_require__(/*! moment-timezone */ "./node_modules/moment-timezone/index.js");
...
var windNumber = document.querySelector('#wind-num');
var sunRiseTime = document.querySelector('#sunrise-time');
var sunSetTime = document.querySelector('#sunset-time');
var celciusBtn = document.querySelector('.degrees-btn-C');
var fahrenheitBtn = document.querySelector('.degrees-btn-F');
var city;

var getCityTemp = /*#__PURE__*/function () {
  var _ref = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1___default()( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee(zip) {
    var country,
        url,
        clouds,
        _city$coord,
    ...
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            country = _args.length > 1 && _args[1] !== undefined ? _args[1] : 'US';
            _context.prev = 1;
            url = " https://api.openweathermap.org/data/2.5/weather?zip=".concat(zip, ",").concat(country, "&units=imperial&appid=97238fe444ebb191d0dead1fb52bfed9\n  ");
            _context.next = 5;
            return fetch(url);
          ...
          case 8:
            ...
            clouds = city.weather[0].description;
            ...
            humidityNumber.textContent = "".concat(Math.round("".concat(city.main.humidity)), "%");
            windNumber.textContent = "".concat(Math.round("".concat(city.wind.speed)), "mph");
            _city$coord = city.coord, lat = _city$coord.lat, lon = _city$coord.lon;
            times = SunCalc.getTimes(new Date(), lat, lon);
            sunRise = "".concat(times.sunrise).split(' ')[4].replace(/^0+/, '').trim().split(':').slice(0, -1).join(':');
            console.log("".concat(sunRise, "am"));
...
var getCity = function getCity(e) {
  if (e.target === input && e.key === 'Enter') {
    var usersZipCode = input.value;
...
var setBackgroundImg = function setBackgroundImg() {
  ...
  if (coverage.includes('snow')) {
    ...
    var snow = coverage.indexOf('rain');
    snow = coverage[snow];
    img.style.backgroundImage = "url(/src/images/".concat(snow, ".jpeg)");
  } else if (coverage.includes('rain')) {
    coverage = coverage.replace('-', '');
    coverage = coverage.split(' ');
    var rain = coverage.indexOf('rain');
    rain = coverage[rain];
    img.style.backgroundImage = "url(/src/images/".concat(rain, ".jpeg)");
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".hidden {\n  display: none;\n}\n\nh1 {\n  width: 15%;\n  display: flex;\n  justify-content: center;\n}\n\nbutton {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  padding: 0.7rem;\n  width: 1rem;\n  height: 1rem;\n  margin-left: 1rem;\n  font-size: 0.9rem;\n  border-radius: 50%;\n  outline: none;\n  border: none;\n  cursor: pointer;\n  margin-left: 0%;\n}\n\nform {\n  display: flex;\n  width: 15%;\n  justify-content: space-evenly;\n}\n\n.city-time-container {\n  display: flex;\n  flex-direction: column;\n  width: 15%;\n  align-items: center;\n}\n\n#feels-humid-wind-sun-container {\n  display: flex;\n  width: 15%;\n  justify-content: space-evenly;\n}\n\nh5 {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n}\n\n#sun {\n  display: flex;\n  width: 15%;\n  justify-content: space-evenly;\n}\n\n.body {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n}\n\nhtml {\n  background: url() no-repeat center fixed;\n  -webkit-background-size: cover;\n  -moz-background-size: cover;\n  -o-background-size: cover;\n  background-size: cover;\n}\n\ninput {\n  text-align: center;\n  outline: none;\n  background-color: \n}", "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA;EACE,aAAa;AACf;;AAEA;EACE,UAAU;EACV,aAAa;EACb,uBAAuB;AACzB;;AAEA;EACE,aAAa;EACb,mBAAmB;EACnB,uBAAuB;EACvB,eAAe;EACf,WAAW;EACX,YAAY;EACZ,iBAAiB;EACjB,iBAAiB;EACjB,kBAAkB;EAClB,aAAa;EACb,YAAY;EACZ,eAAe;EACf,eAAe;AACjB;;AAEA;EACE,aAAa;EACb,UAAU;EACV,6BAA6B;AAC/B;;AAEA;EACE,aAAa;EACb,sBAAsB;EACtB,UAAU;EACV,mBAAmB;AACrB;;AAEA;EACE,aAAa;EACb,UAAU;EACV,6BAA6B;AAC/B;;AAEA;EACE,aAAa;EACb,sBAAsB;EACtB,mBAAmB;AACrB;;AAEA;EACE,aAAa;EACb,UAAU;EACV,6BAA6B;AAC/B;;AAEA;EACE,aAAa;EACb,sBAAsB;EACtB,mBAAmB;AACrB;;AAEA;EACE,wCAAwC;EACxC,8BAA8B;EAC9B,2BAA2B;EAC3B,yBAAyB;EACzB,sBAAsB;AACxB;;AAEA;EACE,kBAAkB;EAClB,aAAa;EACb;AACF","sourcesContent":[".hidden {\n  display: none;\n}\n\nh1 {\n  width: 15%;\n  display: flex;\n  justify-content: center;\n}\n\nbutton {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  padding: 0.7rem;\n  width: 1rem;\n  height: 1rem;\n  margin-left: 1rem;\n  font-size: 0.9rem;\n  border-radius: 50%;\n  outline: none;\n  border: none;\n  cursor: pointer;\n  margin-left: 0%;\n}\n\nform {\n  display: flex;\n  width: 15%;\n  justify-content: space-evenly;\n}\n\n.city-time-container {\n  display: flex;\n  flex-direction: column;\n  width: 15%;\n  align-items: center;\n}\n\n#feels-humid-wind-sun-container {\n  display: flex;\n  width: 15%;\n  justify-content: space-evenly;\n}\n\nh5 {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n}\n\n#sun {\n  display: flex;\n  width: 15%;\n  justify-content: space-evenly;\n}\n\n.body {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n}\n\nhtml {\n  background: url() no-repeat center fixed;\n  -webkit-background-size: cover;\n  -moz-background-size: cover;\n  -o-background-size: cover;\n  background-size: cover;\n}\n\ninput {\n  text-align: center;\n  outline: none;\n  background-color: \n}"],"sourceRoot":""}]);
// Exports
